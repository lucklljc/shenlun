<template>
    ...
    <div class="container">
        <div id="answerSheet">
            <div class="row" v-for="count in forCount" :key="count">
                <el-input ref="inputRef" :model-value="answers[count]" max-length="1"
        ...
        <div v-for="num in forCount / 100">
            <el-text class="number" type="danger" size="default" :style="{ top: `${(num * 100 * 50) / 20 + 25}px` }">{{
                num }}00字</el-text>
        </div>
    </div>
